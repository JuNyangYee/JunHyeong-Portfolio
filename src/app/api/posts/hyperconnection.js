const Page = {
    ...
    contents: (
        <div>
            ...
            <p>VR 플레이가 가능하도록 전체적인 시스템 수정과, 최적화 작업을 진행했습니다.</p>

            <ul>
                <li><strong>블루프린트 최적화</strong><br />
                    기존 작업자가 작업한 내용들을 정리하면서 통합이 가능한 것들은 블루프린트 클래스도 새롭게 제작하여 관리하였습니다.
                </li>
                ...
                <li><strong>Niagara</strong><br />
                    기존 Cascade로 제작되어있던 대부분의 이펙트를 Niagara를 이용해 변경하였습니다. <br />
                    추가로 제작이 필요한 이펙트들 역시 Niagara를 이용해 제작했습니다.
                </li>
            ...
            <ul>
                ...
                <li><strong>프로젝트 패키징</strong><br />
                    Windows 버전 패키징을 진행해 .exe 실행파일로 간편하게 실행할 수 있도록 패키징을 진행했습니다.
                </li>
            ...
            <p>
                다른 분들이 제작했던 프로젝트를 바탕으로 작업을 시작하게 되었습니다. <br />
                이전에 어떻게 작업이 되었는지 확인이 어려워 조금은 헤멨지만, 하나하나 풀어가다보니 큰 문제없이 잘 진행된 것 같습니다.<br />
                이렇게 여러 사람이 작업을 진행하게 된다면, 해당 프로젝트에 맞춰 정해진 가이드나 메뉴얼이 있어야 작업의 유지·보수가 원활하게 진행될 수 있겠다고 느꼈던 작업이었습니다. 관련해서 이 경험이 <a href="https://junyangyee.notion.site/ue-styleguide-junyangyee?pvs=4" target="_blank">스타일 가이드 제작</a> 작업에 많은 도움이 되었던 것 같습니다.
            </p>
            <p>
                언리얼엔진 버전이 5로 넘어온 후 매번 시네마틱 작업 위주로 하다가 처음 진행한 VR 작업이었습니다.<br />
                언리얼엔진5 VR 문서 뿐 아니라, VR 환경에서의 루멘과 나나이트 관련한 문서가 거의 없어서 관련 자료를 찾고 작업을 진행하는데에 막히는 부분이 많았던 것 같습니다. 그래도 이렇게 막히는 부분을 풀어가면서 언리얼엔진5 기반의 VR 작업에 있어서는 나름의 노하우가 쌓이지 않았을까 생각합니다.
            </p>
            ...
            <ul>
                <li><strong>Unreal Engine 5.3.2</strong><br />
                    VR 시스템 및 블루프린트 최적화 등 언리얼엔진을 활용해 작업했습니다.
                </li>
                <li><strong>Adobe AfterEffect</strong><br />
                    플레이에 등장하는 영상들의 자막 및 해상도 관련 작업을 진행했습니다.
                </li>
            </ul>
        </div>
    )
