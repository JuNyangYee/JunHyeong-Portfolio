const Page = {
    ...
    contents: (
        <div>
            ...
            <p>
                처음으로 언리얼엔진을 활용해 혼자 제작해본 게임입니다. <br />
                게임을 혼자 제작해보면서 각 파트별로 어떤 식으로 작업이 진행되어 가는지, 해당 작업에서 어떤 어려움이 발생할 수 있는지, 어떤 오류가 생기고 그 해결 방법은 무엇인지 등, 각 파트에서 일어날 수 있는 일들을 폭넓게 알아갈 수 있는 작업이었습니다.
            </p>
