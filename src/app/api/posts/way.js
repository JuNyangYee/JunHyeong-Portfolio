const Page = {
    ...
    contents: (
        <div>
            ...
            <p>
                전시에 사용 예정인 PC는 당시 고사양 PC였지만, 그 PC로 계속해서 작업을 할 수 없다보니,  <br />
                모든 최적화를 제 개인 PC에 맞춰서 진행하게 되었습니다.<br />
                오히려 낮은 사양을 기준으로 최적화 작업을 진행하니, 추후 전시에서 프레임이 안정적이고 원활하게 실행되었던 것 같습니다.<br />
            </p>
            <p>
                작업에 있어서 최고사양, 가장 완벽한 퀄리티도 중요하지만, 최저사양 역시 중요하다고 깨달을 수 있었던 것 같습니다. <br />
                해당 작업이 어느 환경에서 돌아갈지, 무슨 문제가 생길지 알 수 없는 상황에서 최저 기준이 있다면, 그 기준에 맞춘 이후에 점점 더 퀄리티를 높여가는 방법도 좋은 것 같다고 생각합니다.
            </p>
