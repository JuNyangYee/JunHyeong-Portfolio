const Page = {
    ...
    contents: (
        <div>
            ...
            <p>
                처음으로 진행한 터치디자이너 프로젝트입니다. <br />
                터치디자이너 툴에 익숙하지 않기도 하고, 노드도 어떻게 활용할지 잘 몰라서 헤메긴 했지만, <br />
                노드를 이용해 비주얼적으로 뽑아내는 작업이 아닌 데이터 관리 느낌의 작업이었던만큼, 코드로 해결할 수 있는 부분이 많아, 대부분을 코딩으로 진행하면서 조금은 편하게 작업할 수 있었던 것 같습니다. <br />
            </p>
